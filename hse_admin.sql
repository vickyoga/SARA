...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 19, 2024 at 06:41 PM
...
CREATE TABLE `category` (
  ...
  `ins_ipaddress` varchar(50) NOT NULL,
  `ins_date` timestamp(6) NULL DEFAULT NULL,
  `upd_username` varchar(50) NOT NULL,
  `upd_ipaddress` varchar(50) NOT NULL,
  `upd_date` timestamp(6) NULL DEFAULT NULL,
  `del_flag` varchar(1) DEFAULT NULL,
  `del_username` varchar(50) NOT NULL,
  `del_ipaddress` varchar(50) NOT NULL,
  `del_date` timestamp(6) NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `category` (`category_id`, `category_name`, `isactive`, `ins_username`, `ins_ipaddress`, `ins_date`, `upd_username`, `upd_ipaddress`, `upd_date`, `del_flag`, `del_username`, `del_ipaddress`, `del_date`) VALUES
(26, 'test1', '1', 'Admin', '10.10', '2024-08-16 11:21:19.000000', 'Admin', '10.10', '2024-08-16 11:23:02.000000', NULL, 'Admin', '10.10', '2024-08-16 11:23:39.000000'),
(27, 'test2', '1', 'Admin', '10.10', '2024-08-16 11:57:17.000000', '', '', NULL, NULL, '', '', NULL),
(28, 'Fabrications', '1', 'Admin', '10.10', '2024-08-19 10:08:06.000000', '', '', NULL, NULL, '', '', NULL);
...
INSERT INTO `designer` (`designer_id`, `designer_name`, `mobile`, `isactive`, `ins_username`, `ins_ipaddress`, `ins_date`, `upd_username`, `upd_ipaddress`, `upd_date`, `del_flag`, `del_username`, `del_ipaddress`, `del_date`) VALUES
(1, 'fdfsdfddddddd', '3234444444', '1', 'Admin', '10.10', '2024-08-18 20:43:05.000000', 'Admin', '10.10', '2024-08-18 20:45:37.000000', 'Y', 'Admin', '10.10', '2024-08-18 20:45:43.000000');
...
--
-- Table structure for table `in_ward`
--

CREATE TABLE `in_ward` (
  `in_ward_id` int(11) NOT NULL,
  `in_ward_code` int(25) DEFAULT NULL,
  `in_ward_date` date DEFAULT NULL,
...
--
-- Dumping data for table `in_ward`
--

INSERT INTO `in_ward` (`in_ward_id`, `in_ward_code`, `in_ward_date`, `supplier_id`, `isactive`, `ins_username`, `ins_ipaddress`, `ins_date`, `upd_username`, `upd_ipaddress`, `upd_date`, `del_flag`, `del_username`, `del_ipaddress`, `del_date`) VALUES
(41, 1, '2024-08-18', 26, '1', 'Admin', '10.10', '2024-08-18 10:17:17.000000', '', '', NULL, NULL, '', '', NULL),
(42, 2, '2024-08-01', 26, '1', 'Admin', '10.10', '2024-08-18 17:33:55.000000', '', '', NULL, NULL, '', '', NULL),
(43, 3, '2024-08-09', 26, '1', 'Admin', '10.10', '2024-08-18 21:07:39.000000', '', '', NULL, NULL, '', '', NULL);

-- --------------------------------------------------------

--
-- Table structure for table `in_ward_product`
--

CREATE TABLE `in_ward_product` (
  `in_ward_product_id` int(11) NOT NULL,
  `in_ward_id` int(20) DEFAULT NULL,
  `in_ward_code` int(25) DEFAULT NULL,
  `in_ward_date` date DEFAULT NULL,
  `supplier_id` int(20) DEFAULT NULL,
  ...
  `per_qty_amt` int(20) DEFAULT NULL,
  `total_Amount` float DEFAULT NULL,
  `total_gst_Amount` float DEFAULT NULL,
  `isactive` varchar(1) DEFAULT NULL,
  `ins_username` varchar(50) NOT NULL,
  `ins_ipaddress` varchar(50) NOT NULL,
  `ins_date` timestamp(6) NULL DEFAULT NULL,
...
--
-- Dumping data for table `in_ward_product`
--

INSERT INTO `in_ward_product` (`in_ward_product_id`, `in_ward_id`, `in_ward_code`, `in_ward_date`, `supplier_id`, `product_id`, `category_id`, `unit`, `gst`, `qty`, `per_qty_amt`, `total_Amount`, `total_gst_Amount`, `isactive`, `ins_username`, `ins_ipaddress`, `ins_date`, `upd_username`, `upd_ipaddress`, `upd_date`, `del_flag`, `del_username`, `del_ipaddress`, `del_date`) VALUES
(39, 41, 1, '2024-08-18', 26, 27, 26, 1, 12, 1, 1, 1.12, 0.12, '1', 'Admin', '10.10', '2024-08-18 10:17:17.000000', '', '', NULL, NULL, '', '', NULL),
(40, 41, 1, '2024-08-18', 26, 27, 26, 1, 12, 12, 12, 161.28, 17.28, '1', 'Admin', '10.10', '2024-08-18 10:17:17.000000', '', '', NULL, NULL, '', '', NULL),
(41, 42, 2, '2024-08-01', 26, 27, 26, 1, 12, 1, 1, 1.12, 0.12, '1', 'Admin', '10.10', '2024-08-18 17:33:55.000000', '', '', NULL, NULL, '', '', NULL),
(42, 42, 2, '2024-08-01', 26, 27, 26, 1, 12, 2, 2, 4.48, 0.48, '1', 'Admin', '10.10', '2024-08-18 17:33:55.000000', '', '', NULL, NULL, '', '', NULL),
(43, 43, 3, '2024-08-09', 26, 27, 26, 1, 12, 0, 0, 0, 0, '1', 'Admin', '10.10', '2024-08-18 21:07:39.000000', '', '', NULL, NULL, '', '', NULL),
(44, 43, 3, '2024-08-09', 26, 0, 0, 0, 0, 0, 0, 0, 0, '1', 'Admin', '10.10', '2024-08-18 21:07:39.000000', '', '', NULL, NULL, '', '', NULL),
(45, 43, 3, '2024-08-09', 26, 0, 0, 0, 0, 0, 0, 0, 0, '1', 'Admin', '10.10', '2024-08-18 21:07:39.000000', '', '', NULL, NULL, '', '', NULL);
...
INSERT INTO `printer` (`printer_id`, `printer_name`, `contact_person_name`, `mobile`, `address`, `isactive`, `ins_username`, `ins_ipaddress`, `ins_date`, `upd_username`, `upd_ipaddress`, `upd_date`, `del_flag`, `del_username`, `del_ipaddress`, `del_date`) VALUES
(1, 'sdfsddsdfds', 'sdfsd', '3242322343', 'sdfds', '0', 'Admin', '10.10', '2024-08-18 20:18:27.000000', 'Admin', '10.10', '2024-08-18 20:21:37.000000', 'Y', 'Admin', '10.10', '2024-08-18 20:21:43.000000');
...
INSERT INTO `product` (`product_id`, `category_id`, `product_name`, `product_description`, `product_unit`, `gst`, `isactive`, `ins_username`, `ins_ipaddress`, `ins_date`, `upd_username`, `upd_ipaddress`, `upd_date`, `del_flag`, `del_username`, `del_ipaddress`, `del_date`) VALUES
(27, 26, 'product 1', 'product des', '1', 12, '1', 'Admin', '10.10', '2024-08-16 12:40:20.000000', 'Admin', '10.10', '2024-08-17 15:23:48.000000', NULL, '', '', NULL),
(28, 26, 'vignesh1', 'kanjnaur1', '1001', NULL, '1', 'Admin', '10.10', '2024-08-16 12:59:43.000000', 'Admin', '10.10', '2024-08-16 13:00:02.000000', 'Y', 'Admin', '10.10', '2024-08-16 13:05:04.000000'),
(29, 26, 'aa', 'bb', '11', 22, '1', 'Admin', '10.10', '2024-08-17 15:10:37.000000', 'Admin', '10.10', '2024-08-17 15:11:27.000000', 'Y', 'Admin', '10.10', '2024-08-17 15:11:41.000000'),
(30, 28, 'zxcvx', 'zvxc', '34', 34, '1', 'Admin', '10.10', '2024-08-19 10:10:15.000000', '', '', NULL, NULL, '', '', NULL),
(31, 26, 'sadfasdfds', 'sadfdsaf', '4', 324324, '1', 'Admin', '10.10', '2024-08-19 10:14:48.000000', 'Admin', '10.10', '2024-08-19 10:20:18.000000', NULL, '', '', NULL);
...
INSERT INTO `product_type` (`product_type_id`, `product_type_name`, `isactive`, `ins_username`, `ins_ipaddress`, `ins_date`, `upd_username`, `upd_ipaddress`, `upd_date`, `del_flag`, `del_username`, `del_ipaddress`, `del_date`) VALUES
(1, 'testtttttttttttttthhhhhhhhhhh', '0', 'Admin', '10.10', '2024-08-18 18:26:26.000000', 'Admin', '10.10', '2024-08-18 18:26:38.000000', 'Y', 'Admin', '10.10', '2024-08-18 18:26:49.000000'),
(2, 'testttttttttttttt', '1', 'Admin', '10.10', '2024-08-18 18:26:57.000000', '', '', NULL, 'Y', 'Admin', '10.10', '2024-08-18 20:23:26.000000');
...
INSERT INTO `store` (`store_id`, `store_name`, `address`, `isactive`, `ins_username`, `ins_ipaddress`, `ins_date`, `upd_username`, `upd_ipaddress`, `upd_date`, `del_flag`, `del_username`, `del_ipaddress`, `del_date`) VALUES
(1, 'xdserere', 'sasdasertert', '1', 'Admin', '10.10', '2024-08-18 19:40:26.000000', 'Admin', '10.10', '2024-08-18 19:41:11.000000', 'Y', 'Admin', '10.10', '2024-08-18 19:41:17.000000');
...
INSERT INTO `supplier` (`supplier_id`, `name`, `mobile`, `gst`, `bank`, `address`, `isactive`, `ins_username`, `ins_ipaddress`, `ins_date`, `upd_username`, `upd_ipaddress`, `upd_date`, `del_flag`, `del_username`, `del_ipaddress`, `del_date`) VALUES
(26, 'Suppliervicky', '5876577567', '12', 'indian bank', 'kaninaur', '1', 'Admin', '10.10', '2024-08-17 15:20:21.000000', '', '', NULL, NULL, '', '', NULL),
(27, 'suplliersunil', '8456456456', '12', 'karurvais bank', 'erode', '1', 'Admin', '10.10', '2024-08-17 15:20:51.000000', '', '', NULL, NULL, '', '', NULL),
(28, 'test', '1234567890', '123qwe456', 'asdfasdf\r\n123124', '11224qwwe', '1', 'Admin', '10.10', '2024-08-19 10:07:03.000000', '', '', NULL, NULL, '', '', NULL);
...
INSERT INTO `unit` (`unit_id`, `unit`, `isactive`, `ins_username`, `ins_ipaddress`, `ins_date`, `upd_username`, `upd_ipaddress`, `upd_date`, `del_flag`, `del_username`, `del_ipaddress`, `del_date`) VALUES
(4, 'test', 1, 'Admin', '10.10', '2024-08-18 17:32:45.000000', '', '', NULL, NULL, '', '', NULL),
(5, 'kg', 1, 'Admin', '10.10', '2024-08-19 10:07:24.000000', '', '', NULL, NULL, '', '', NULL);
...
(2, 'b', 'admin', 'WFQzOWF2NUl3T3d1OTdtWnJBamVxZz09', 2, 1, '::1', '2024-08-19 22:04:48', '2024-08-19 16:34:48', '2024-08-19 16:34:48', '1');
...
--
-- Indexes for table `in_ward`
--
ALTER TABLE `in_ward`
  ADD PRIMARY KEY (`in_ward_id`);

--
-- Indexes for table `in_ward_product`
--
ALTER TABLE `in_ward_product`
  ADD PRIMARY KEY (`in_ward_product_id`);
...
--
ALTER TABLE `cilent`
  MODIFY `cilent_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `in_ward`
--
ALTER TABLE `in_ward`
  MODIFY `in_ward_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;

--
-- AUTO_INCREMENT for table `in_ward_product`
--
ALTER TABLE `in_ward_product`
  MODIFY `in_ward_product_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;
