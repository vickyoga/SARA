...
<h4>Already have an account? &nbsp;<a href="login.php"><span class="text-success"><strong>Sign in here</strong></span></a></h4>
<div class="row">
<div class="form-line col-md-6">
      <label for="first name">First Name<span class="validation">*</span></label>
      <input type="name" class="form-control" id="name" placeholder="" name="email">
    </div>
	<div class="form-line col-md-6">
      <label for="first name">Last Name<span class="validation">*</span></label>
      <input type="name" class="form-control" id="name" placeholder="" name="email">
    </div>
	<div class="form-line col-md-6">
      <label for="first name">Email<span class="validation">*</span></label>
      <input type="name" class="form-control" id="name" placeholder="" name="email">
    </div>
	<div class="form-line col-md-6">
      <label for="first name">Mobile Number<span class="validation">*</span></label>
      <input type="name" class="form-control" id="name" placeholder="" name="name">
    </div>
	<div class="form-group col-md-12">
  <label for="comment">Shop Location<span class="validation">*</span></label>
  <textarea class="form-control" rows="2" id="comment"></textarea>
</div>
    <div class="form-line col-md-6">
      <label for="email">Password<span class="validation">*</span></label>
      <input type="email" class="form-control" id="email" placeholder="" name="email">
    </div>
	<div class="form-line col-md-6">
      <label for="mobile no">Repeat Password<span class="validation">*</span></label>
      <input type="mobile" class="form-control" id="name" placeholder="" name="mobile no">
    </div>
	<div class="row">
	<div class="col-md-4 offset-md-4">
	<a href=""><div class="button">Sign Up</div></a>
	</div>
	</div>
	</div>
</div>
