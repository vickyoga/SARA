					...
					<div class="card-box height-100-p widget-style1">
						<div class="d-flex flex-wrap align-items-center">
							...
							<div class="widget-data">
								...
								<div class="weight-600 font-14">Footwear</div>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="card-box height-100-p widget-style1">
						<div class="d-flex flex-wrap align-items-center">
							...
							<div class="widget-data">
								...
								<div class="weight-600 font-14">Appearls & Accessories</div>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="card-box height-100-p widget-style1">
						<div class="d-flex flex-wrap align-items-center">
							...
							<div class="widget-data">
								...
								<div class="weight-600 font-14">Materials</div>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="card-box height-100-p widget-style1">
						<div class="d-flex flex-wrap align-items-center">
							...
							<div class="widget-data">
								...
								<div class="weight-600 font-14">Supply Chain Solution</div>
							</div>
						</div>
					</div>
				</div>
