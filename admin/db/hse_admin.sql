...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 27, 2022 at 08:21 AM
...
(1, 'image/Cont_ban_img/4cb017ad892d9379e01b858427f21424.webp', 'Contact', 'Get the latest news and feature stories on our businesses, community initiatives, heritage, and people. Scroll to read.', '2022-04-25 07:56:49', 1);
...
INSERT INTO `hu_banner` (`b_id`, `b_tittle`, `b_content`, `b_img_path`, `date_time`, `active_record`) VALUES
(1, 'Moving Forward', 'To become a universal creator platform. ', 'image/banner_img/b7cefe5a1b46f130e7251de2497524a8.webp', '2022-04-25 06:01:43', 1),
(2, 'Flawless Execution', 'To make the world suitable for our future generation. ', 'image/banner_img/4b5bea3aa469dc25cfa09b12ade54a8c.webp', '2022-04-25 06:02:18', 1),
(3, 'Industry Disruption', 'Helping brands to make their product from best to great.', 'image/banner_img/1b66d38dede020955eba87c4b4516498.webp', '2022-04-25 06:03:00', 1);
...
(2, 'b', 'admin@hse.kr', 'QXRaaGNURWNzb2tJRHZLUXpMaWJyUT09', 2, 1, '::1', '2022-04-27 11:39:17', '2022-04-27 06:09:17', '2022-04-27 06:09:17', '1');
...
--
ALTER TABLE `cont_banner`
  MODIFY `id_Cont_banner` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
