			...
			<div class="user-info-dropdown">
				<div class="dropdown">
					<a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown">
						...
						<span class="user-name">Admin Team</span>
					</a>
					<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
						<a class="dropdown-item" href="profile.php"><i class="dw dw-user1"></i> Profile</a>
						<a class="dropdown-item" href="profile.php"><i class="dw dw-settings2"></i> Setting</a>
						<a class="dropdown-item" href="profile.php"><i class="dw dw-help"></i> Help</a>
						<a class="dropdown-item" href="include/login_action.php?userlog_out=1"><i class="dw dw-logout"></i> Log Out</a>
