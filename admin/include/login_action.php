...
//    echo $user_pass;exit;
	...
	$dbsel_q1 = mysqli_query($dbcon1,"select * from users where email='$user_name' and pass='$user_pass' and status='1'") or die("select query not working");
...

	{
		...
		$log_update = mysqli_query($dbcon1,"update users set log_status='1',login_ip='$ip_address',last_login='$log_date' where id='$user_id'") or die("login date and time update not working!");
...

{
	...
	$log_update = mysqli_query($dbcon1,"update users set log_status='0' where id='$user_id'") or die("session timeout logout update date and time update not working!");
